 ...
 */
public class applySettingsFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        applySettingsFragment fragmentSettings;
        fragmentSettings = (applySettingsFragment) fragmentManager.findFragmentByTag("settings_fragment");
        //checking whether the background fragment has been retained, if not create a new one
        if (fragmentSettings == null) {

            fragmentSettings = new applySettingsFragment();
